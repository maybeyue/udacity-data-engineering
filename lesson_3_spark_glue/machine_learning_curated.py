...
customersteptrainerjoin_node1 = Join.apply(
    frame1=customercurated_node1,
    frame2=steptrainertrusted_node1,
    keys1=["serialNumber"],
    keys2=["serialNumber"],
    transformation_ctx="customersteptrainerjoin_node1",
)

# Script generated for node select steptrainer fields
select_steptrainer_fields_node1693800914951 = SelectFields.apply(
    frame=customersteptrainerjoin_node1,
    paths=["sensorReadingTime", "serialNumber", "distanceFromObject", "email"],
    transformation_ctx="select_steptrainer_fields_node1693800914951",
)

# Script generated for join step trainer accelerometer data
joinsteptraineraccelerometer_node1 = Join.apply(
    frame1=select_steptrainer_fields_node1693800914951,
    frame2=accelerometertrusted_node1,
    keys1=["sensorReadingTime", "email"],
    keys2=["timeStamp", "user"],
    transformation_ctx="joinsteptraineraccelerometer_node1",
)


# Script generated for node customer_curated
machinelearningcurated_node1 = glueContext.write_dynamic_frame.from_options(
    frame=joinsteptraineraccelerometer_node1,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://stedi-lake-house/machine_learning/curated/",
        "partitionKeys": [],
    },
    transformation_ctx="machinelearningcurated_node1",
)
